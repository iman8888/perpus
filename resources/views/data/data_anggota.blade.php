    ...
    <table id="data" class="table table-bordered table-striped">
      ...
      @foreach($anggota as $rsAng)
        <tr>
            ...
            <a href="{{ url('anggota/edit/'.$rsAng['id_anggota']) }}"><button type="button" class="btn bg-yellow btn-flat"><i class="fa fa-pencil"></i></button></a>
            <a href="{{ url('anggota/hapus/'.$rsAng['id_anggota']) }}"><button type="button" class="btn bg-red btn-flat"><i class="fa fa-trash"></i></button></a>
            </td>
        </tr>
        @endforeach
      </tbody>
