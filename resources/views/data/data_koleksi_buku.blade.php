    ...
    <table id="data" class="table table-bordered table-striped">
      ...
      @foreach($koleksi as $rsKoleksi)
        <tr>
            ...
            <td>
            <a href="{{ url('koleksi/edit',$rsKoleksi->id_koleksi) }}"><button type="button" class="btn bg-yellow btn-flat"><i class="fa fa-pencil"></i></button></a>
            <a href="{{ url('koleksi/hapus',$rsKoleksi->id_koleksi) }}"><button type="button" class="btn bg-red btn-flat"><i class="fa fa-trash"></i></button></a>
            </td>
        </tr>
        @endforeach
      </tbody>
